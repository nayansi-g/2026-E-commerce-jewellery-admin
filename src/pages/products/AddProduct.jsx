...
const AddProduct = () => {
  ...
  const fetchCategories = async ()=>{
    try{
        let res = await fetch("https://two026-e-commerce-jewellery-backend.onrender.com/category");
  ...
  const res = await fetch("https://two026-e-commerce-jewellery-backend.onrender.com/product/admin/create", {
        method: "POST",
        headers: {
