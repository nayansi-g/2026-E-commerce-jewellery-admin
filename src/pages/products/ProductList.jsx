...
const ProductList = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const res = await fetch("https://two026-e-commerce-jewellery-backend.onrender.com/product", {
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://two026-e-commerce-jewellery-backend.onrender.com/product/delete/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
